...
```text
feeds/ecommerce.web-sources.json
```

这些源属于 P0 级重点网页源，例如淘宝规则中心、天猫规则频道、京东规则中心、拼多多规则中心、抖音电商规则中心、小红书电商官方资讯、快手电商规则中心、巨量千川规则中心、腾讯广告帮助中心、饿了么规则中心、美团规则中心、支付宝开放平台规则中心等。它们多数没有 RSS，所以不会写进 OPML；后续需要用网页列表适配器采集。
